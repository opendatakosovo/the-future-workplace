    ...
    <div class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
          <span class="float-md-left d-block footer-funded-text d-md-inline-block" style="text-align: left;float: right ">{{ Lang::get('translation.funded_by')}}
              <div class="funded-logos">
                ...
                <img src="/app-assets/css/about_us/img/clients/MCC.png" style="width: 150px; " alt="">
            </div>
        </span>
        <span class="float-md-right d-block footer-funded-text d-md-inline-block" style="text-align: left;float: right ">{{ now()->year }} &copy;  {{Lang::get('translation.implemented_by')}}
            <div class="funded-logos">
                <img src="/app-assets/css/about_us/img/clients/ODK.png" style="margin-top:10%; width: 120px; padding-left: 5%;" alt="">
                <img src="/app-assets/css/about_us/img/clients/oek.svg" style="margin-top:10%; width: 80px; " alt="">
            </div>
        </span>
