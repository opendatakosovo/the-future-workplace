                    ...
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li>
                                    <a class="btn btn-glow btn-round btn-bg-gradient-x-green-pink" href="{{ url(app()->getLocale().'/workforce-map') }}">{{Lang::get('translation.more')}}</a>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li>
                                    <a class="btn btn-glow btn-round btn-bg-gradient-x-green-pink" href="{{ url(app()->getLocale().'/highschool-data') }}">{{Lang::get('translation.more')}}</a>
                            </ul>
                        </div>
                    </div>
                    <div class="card-content collapse show">
                        ...
                        <div class="card pull-up border-top-info border-top-3 rounded-0">
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-footer p-1">
                                    <span class="text-muted"><i class="la @if($data['growth_uni'] < 0 )la-arrow-circle-o-down @else la-arrow-circle-o-up @endif  info"></i> {{$data['growth_uni']}}% @if($data['growth_uni'] < 0 ){{Lang::get('translation.drop')}} @else {{Lang::get('translation.growth')}}  @endif {{Lang::get('translation.within_uni_years')}} </span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="card pull-up border-top-info border-top-3 rounded-0">
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-footer p-1">
                                    <span class="text-muted"><i class="la @if($data['growth'] < 0 )la-arrow-circle-o-down @else la-arrow-circle-o-up @endif  info"></i> {{$data['growth']}}% @if($data['growth'] < 0 ){{Lang::get('translation.drop')}} @else {{Lang::get('translation.growth')}}  @endif {{Lang::get('translation.within_hs_years')}} </span>
                                </div>
                            </div>
                        </div>
                    </div>
